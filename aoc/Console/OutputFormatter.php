...
class OutputFormatter implements WrappableOutputFormatterInterface
{
    ...
    protected OutputFormatterStyleStack $styleStack;
     ...
     */
    protected function applyCurrentStyle(string $text, string $current, int $width, int &$currentLineLength): string
    {
        if ('' === $text) {
            return '';
        }
    ...
    protected function addLineBreaks(string $text, int $width): string
    {
